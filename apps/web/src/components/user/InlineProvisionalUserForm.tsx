...
import { ProvisionalUserData } from '@fuseloja/types';
...
interface InlineProvisionalUserFormProps {
  onSuccess?: () => void;
}

export const InlineProvisionalUserForm: React.FC<InlineProvisionalUserFormProps> = ({ 
  onSuccess
}) => {
