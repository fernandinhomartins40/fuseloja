...
export const BestSellerProducts: React.FC = () => {
  return <section className="py-12 bg-slate-50">
      <div className="container mx-auto px-4">
        <SectionHeader title="Mais Vendidos" description="Os produtos preferidos dos nossos clientes" actionLabel="Ver Todos" onAction={() => console.log("Ver todos os mais vendidos")} />
        
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
          {bestSellerProducts.map((product, index) => <div key={index} className="relative w-full">
