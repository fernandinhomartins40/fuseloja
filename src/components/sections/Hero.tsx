...
export const Hero: React.FC = () => {
  return <section className="relative h-[500px] bg-[#0B0909]">
      ...
      <div className="absolute -translate-y-2/4 w-full flex justify-between px-2.5 py-0 top-2/4 z-20">
        <button className="bg-transparent border-none cursor-pointer" aria-label="Slide anterior">
        ...
        <button className="bg-transparent border-none cursor-pointer" aria-label="Próximo slide">
          <svg width="26" height="25" viewBox="0 0 26 25" fill="none" xmlns="http://www.w3.org/2000/svg">
